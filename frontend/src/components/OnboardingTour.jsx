...
function StockDirectoryWidget({ isLight }) {
  ...
  const ALL_STOCKS = [
    ...
    { code: "INFS", name: "Infisys", sector: "IT", price: 1600.00, change: -0.9, desc: "Top digital IT giant specializing in next-generation cloud infrastructure, enterprise software development & tech consulting." },
